...
class Language(object):
    ...
    def __repr__(self):
        return "{}({})".format(
            ...
            ", ".join(
                "{}={!r}".format(k, v) for k, v in self.__dict__.items() if not k.startswith("_")
            ),
        )
...
LANGUAGES = {
    ...
    "Belarusian": Language(
        ...
        alphabet=(u"АБВГДЕЁЖЗІЙКЛМНОПРСТУЎФХЦЧШЫЬЭЮЯ" u"абвгдеёжзійклмнопрстуўфхцчшыьэюяʼ"),
    ...
    "Bulgarian": Language(
        ...
        alphabet=(u"АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЬЮЯ" u"абвгдежзийклмнопрстуфхцчшщъьюя"),
    ...
    "Greek": Language(
        ...
        alphabet=(u"αβγδεζηθικλμνξοπρσςτυφχψωάέήίόύώ" u"ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΣΤΥΦΧΨΩΆΈΉΊΌΎΏ"),
    ...
    "Esperanto": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-3"],
        alphabet=(u"abcĉdefgĝhĥijĵklmnoprsŝtuŭvz" u"ABCĈDEFGĜHĤIJĴKLMNOPRSŜTUŬVZ"),
    ...
    "Estonian": Language(
        ...
        # loanwords
        alphabet=(u"ABDEGHIJKLMNOPRSTUVÕÄÖÜ" u"abdeghijklmnoprstuvõäöü"),
    ...
    "French": Language(
        ...
        wiki_start_pages=[u"Wikipédia:Accueil_principal", u"Bœuf (animal)"],
    ),
    "Hebrew": Language(
        name="Hebrew",
        iso_code="he",
    ...
    "Croatian": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=(u"abcčćdđefghijklmnoprsštuvzž" u"ABCČĆDĐEFGHIJKLMNOPRSŠTUVZŽ"),
    ...
    "Hungarian": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=(u"abcdefghijklmnoprstuvzáéíóöőúüű" u"ABCDEFGHIJKLMNOPRSTUVZÁÉÍÓÖŐÚÜŰ"),
    ...
    "Lithuanian": Language(
        ...
        alphabet=(u"AĄBCČDEĘĖFGHIĮYJKLMNOPRSŠTUŲŪVZŽ" u"aąbcčdeęėfghiįyjklmnoprsštuųūvzž"),
    ...
    "Latvian": Language(
        ...
        alphabet=(u"AĀBCČDEĒFGĢHIĪJKĶLĻMNŅOPRSŠTUŪVZŽ" u"aābcčdeēfgģhiījkķlļmnņoprsštuūvzž"),
    ...
    "Macedonian": Language(
        ...
        alphabet=(u"АБВГДЃЕЖЗЅИЈКЛЉМНЊОПРСТЌУФХЦЧЏШ" u"абвгдѓежзѕијклљмнњопрстќуфхцчџш"),
    ...
    "Polish": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=(u"AĄBCĆDEĘFGHIJKLŁMNŃOÓPRSŚTUWYZŹŻ" u"aąbcćdeęfghijklłmnńoóprsśtuwyzźż"),
    ...
    "Russian": Language(
        ...
        iso_code="ru",
        use_ascii=False,
        charsets=["ISO-8859-5", "WINDOWS-1251", "KOI8-R", "MacCyrillic", "IBM866", "IBM855"],
        alphabet=(u"абвгдеёжзийклмнопрстуфхцчшщъыьэюя" u"АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ"),
    ...
    "Slovene": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
        alphabet=(u"abcčdefghijklmnoprsštuvzž" u"ABCČDEFGHIJKLMNOPRSŠTUVZŽ"),
    ...
    "Serbian": Language(
        name="Serbian",
        iso_code="sr",
        alphabet=(u"АБВГДЂЕЖЗИЈКЛЉМНЊОПРСТЋУФХЦЧЏШ" u"абвгдђежзијклљмнњопрстћуфхцчџш"),
        charsets=["ISO-8859-5", "WINDOWS-1251", "MacCyrillic", "IBM855"],
    ...
    "Turkish": Language(
        ...
        alphabet=(u"abcçdefgğhıijklmnoöprsştuüvyzâîû" u"ABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVYZÂÎÛ"),
    ...
    "Vietnamese": Language(
        ...
        alphabet=(u"aăâbcdđeêghiklmnoôơpqrstuưvxy" u"AĂÂBCDĐEÊGHIKLMNOÔƠPQRSTUƯVXY"),
