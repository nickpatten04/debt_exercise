...
from pip._internal.utils.misc import WHEEL_EXTENSION, redact_password_from_url, splitext
...
class Link(KeyBasedCompareMixin):
    ...
    def __str__(self):
        if self.requires_python:
            ...
            rp = ""
        if self.comes_from:
            return "%s (from %s)%s" % (redact_password_from_url(self.url), self.comes_from, rp)
        else:
