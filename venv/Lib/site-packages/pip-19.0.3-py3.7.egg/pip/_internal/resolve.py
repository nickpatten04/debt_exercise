...
if MYPY_CHECK_RUNNING:
    ...
    from pip._internal.operations.prepare import DistAbstraction, RequirementPreparer  # noqa: F401
...
class Resolver(object):
    ...
    def __init__(
        ...
        self._discovered_dependencies = defaultdict(list)  # type: DefaultDict[str, List]
    ...
    def _get_abstract_dist_for(self, req):
        ...
        abstract_dist = self.preparer.prepare_linked_requirement(
            req, self.session, self.finder, upgrade_allowed, self.require_hashes
        )
        ...
        with indent_log():
            ...
            if not self.ignore_dependencies:
                if req_to_install.extras:
                    logger.debug(
                        "Installing extra requirements: %r", ",".join(req_to_install.extras)
                    )
