...
if MYPY_CHECK_RUNNING:
    ...
    from pip._vendor.pkg_resources import Distribution, Requirement  # noqa: F401
...
def get_requirement_info(dist):
    ...
    if not vc_type:
        ...
        logger.debug("No VCS found for editable requirement {!r} in: {!r}", req, location)
        comments = ["# Editable install with no version control ({})".format(req)]
    ...
    try:
        ...
        req = dist.as_requirement()
        comments = ["# Editable {} install with no remote ({})".format(vc_type.__name__, req)]
        return (location, True, comments)
