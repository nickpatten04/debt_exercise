...
version = partial(
    Option, "-V", "--version", dest="version", action="store_true", help="Show version and exit."
)  # type: Callable[..., Option]
...
cert = partial(
    Option, "--cert", dest="cert", type="str", metavar="path", help="Path to alternate CA bundle."
)  # type: Callable[..., Option]
...
always_unzip = partial(
    Option, "-Z", "--always-unzip", dest="always_unzip", action="store_true", help=SUPPRESS_HELP
)  # type: Callable[..., Option]
...
def _merge_hash(option, opt_str, value, parser):
    ...
    try:
        ...
        parser.error(
            ...
            "followed by a value, like --hash=sha256:abcde..." % opt_str
        )
    if algo not in STRONG_HASHES:
        parser.error("Allowed hash algorithms for %s are %s." % (opt_str, ", ".join(STRONG_HASHES)))
