...
class _Prefix:
    def __init__(self, path):
        ...
        self.bin_dir = get_paths(
            "nt" if os.name == "nt" else "posix_prefix", vars={"base": path, "platbase": path}
        )["scripts"]
...
class BuildEnvironment(object):
    ...
    def __init__(self):
        ...
        system_sites = {
            ...
            for site in (get_python_lib(plat_specific=False), get_python_lib(plat_specific=True))
        }
    ...
    def install_requirements(
        ...
        for format_control in ("no_binary", "only_binary"):
            ...
            args.extend(
                ("--" + format_control.replace("_", "-"), ",".join(sorted(formats or {":none:"})))
            )
