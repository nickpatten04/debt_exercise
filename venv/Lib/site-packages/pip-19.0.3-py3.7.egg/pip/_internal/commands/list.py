...
class ListCommand(Command):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            "-o", "--outdated", action="store_true", default=False, help="List outdated packages"
        )
        cmd_opts.add_option(
            "-u", "--uptodate", action="store_true", default=False, help="List uptodate packages"
        )
        cmd_opts.add_option(
            "-e", "--editable", action="store_true", default=False, help="List editable projects."
        )
        cmd_opts.add_option(
            "-l",
            "--local",
...
def tabulate(vals):
    ...
    for row in vals:
        display = " ".join(
            [str(c).ljust(s) if c is not None else "" for s, c in zip_longest(sizes, row)]
        )
