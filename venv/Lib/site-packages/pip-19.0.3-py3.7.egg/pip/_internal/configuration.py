...
from pip._internal.exceptions import ConfigurationError, ConfigurationFileCouldNotBeLoaded
...
class Configuration(object):
    ...
    def __init__(self, isolated, load_only=None):
        ...
        self._override_order = [kinds.GLOBAL, kinds.USER, kinds.VENV, kinds.ENV, kinds.ENV_VAR]
