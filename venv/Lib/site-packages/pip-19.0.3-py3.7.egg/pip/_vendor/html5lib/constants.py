...
E = {
    ...
    "cant-convert-numeric-entity": "Numeric entity couldn't be converted to character "
    "(codepoint U+%(charAsInt)08x).",
    "illegal-codepoint-for-numeric-entity": "Numeric entity represents an illegal codepoint: "
    "U+%(charAsInt)08x.",
    ...
    "expected-tag-name-but-got-question-mark": "Expected tag name. Got '?' instead. (HTML doesn't "
    ...
    "unexpected-start-tag-implies-end-tag": "Unexpected start tag (%(startName)s) "
    ...
    "adoption-agency-4.4": "End tag (%(name)s) violates step 4, "
    ...
    "unexpected-start-tag-implies-table-voodoo": "Unexpected start tag (%(name)s) in "
    "table context caused voodoo mode.",
    ...
    "unexpected-select-in-select": "Unexpected select start tag in the select phase "
    "treated as select end tag.",
    "unexpected-input-in-select": "Unexpected input start tag in the select phase.",
    "unexpected-start-tag-in-select": "Unexpected start tag token (%(name)s in the select phase. "
    "Ignored.",
    ...
    "unexpected-frameset-in-frameset-innerhtml": "Unexpected end tag token (frameset) "
...
tableInsertModeElements = frozenset(["table", "tbody", "tfoot", "thead", "tr"])
...
rcdataElements = frozenset(["style", "script", "xmp", "iframe", "noembed", "noframes", "noscript"])
...
tagTokenTypes = frozenset([tokenTypes["StartTag"], tokenTypes["EndTag"], tokenTypes["EmptyTag"]])
