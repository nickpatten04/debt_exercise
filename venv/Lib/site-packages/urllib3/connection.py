...
class HTTPSConnection(HTTPConnection):
    ...
    def connect(self):
        ...
        self.is_verified = (
            context.verify_mode == ssl.CERT_REQUIRED or self.assert_fingerprint is not None
        )
    ...
    def _connect_tls_proxy(self, hostname, conn):
        ...
        ssl_context = create_proxy_ssl_context(
            self.ssl_version, self.cert_reqs, self.ca_certs, self.ca_cert_dir, self.ca_cert_data
        )
