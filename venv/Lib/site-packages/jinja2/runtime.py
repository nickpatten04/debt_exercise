...
class Undefined(object):
    ...
    __add__ = (
        ...
        __float__
    ) = __complex__ = __pow__ = __rpow__ = __sub__ = __rsub__ = _fail_with_undefined_error
...
class StrictUndefined(Undefined):
    ...
    __iter__ = (
        ...
        __len__
    ) = __nonzero__ = __eq__ = __ne__ = __bool__ = __hash__ = Undefined._fail_with_undefined_error
