...
class Environment(object):
    ...
    def preprocess(self, source, name=None, filename=None):
        ...
        """
        return reduce(
            lambda s, e: e.preprocess(s, name, filename), self.iter_extensions(), text_type(source)
        )
    ...
    def _generate(self, source, name, filename, defer_init=False):
        ...
        """
        return generate(
            source, self, name, filename, defer_init=defer_init, optimized=self.optimized
        )
    ...
    def select_template(self, names, parent=None, globals=None):
        ...
        if not names:
            raise TemplatesNotFound(message=u"Tried to select from an empty list " u"of templates.")
