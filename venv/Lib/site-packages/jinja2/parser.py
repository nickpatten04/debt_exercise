...
class Parser(object):
    ...
    def parse_import_context(self, node, default):
        if self.stream.current.test_any("name:with", "name:without") and self.stream.look().test(
            "name:context"
        ):
    ...
    def parse_assign_target(
        self, with_tuple=True, name_only=False, extra_end_rules=None, with_namespace=False
    ):
